...
INSERT INTO `bird_skeleton`.`site` (`nome`, `intro`, `logo`, `copyright`) VALUES ('Bird Skeleton Beta 1', 'Confira abaixo os anúncios disponíveis para você.', 'site/bird_skeleton_alpha.jpg', '2015 Marcel Bezerra da Silva. Todos os direitos reservados.');
...
CREATE TABLE IF NOT EXISTS `bird_skeleton`.`login` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
INSERT INTO `bird_skeleton`.`login` (`usuario`, `senha`) VALUES ('bird', '$2y$10$5d40f13fe318177525fc0ONFKoYjlYorAen41.sKHtHTnaVgvCa3C');
