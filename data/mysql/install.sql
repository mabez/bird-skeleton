...
CREATE SCHEMA IF NOT EXISTS `bird_skeleton_beta1` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `bird_skeleton_beta1` ;

-- -----------------------------------------------------
-- Table `bird_skeleton`.`site`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bird_skeleton_beta1`.`site` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bird_skeleton_beta1`.`anuncio` (
  `id` INT NOT NULL AUTO_INCREMENT,
