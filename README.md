...
- Caso a aplicação suba utilizando o zendserve, é necessário criar a pasta /var/img no servidor e dar permissão para a aplicação. Caso contrário, é necessário criar a pasta {diretorioProjeto}/public/img onde serão incluidas as imagens pelos formulários administrativos
